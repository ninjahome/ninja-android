...
import static android.media.MediaRecorder.OutputFormat.AAC_ADTS;
...
//                int bps = e.getInteger(e.getIdentifier("rc_audio_encoding_bit_rate", "integer", this.mContext.getPackageName()));
            ...
            this.mMediaRecorder.setOutputFormat(AAC_ADTS);
            this.mMediaRecorder.setAudioEncoder(MediaRecorder.AudioEncoder.AAC);
            this.mAudioPath = Uri.fromFile(new File(SAVE_PATH, System.currentTimeMillis() + "temp.wav"));
    ...
    private void audioDBChanged() {
        if (this.mMediaRecorder != null) {
            try{
                ...
                mAudioRecordListener.onAudioDBChanged(0);
            }
