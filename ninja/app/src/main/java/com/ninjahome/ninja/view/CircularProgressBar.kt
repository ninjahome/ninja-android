...
class CircularProgressBar : View {
    ...
    private var mPrimaryColor = Color.parseColor("#6DCAEC")
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        // 画背景
        canvas.drawCircle(halfWidth.toFloat(), halfHeight.toFloat(), radius - halfStrokeWidth, mPaint)
    ...
    private val rateOfProgress: Float
        private get() = mProgress.toFloat() / mDuration
}