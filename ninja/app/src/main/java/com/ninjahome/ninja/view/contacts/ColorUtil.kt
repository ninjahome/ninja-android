 ...
 */
object ColorUtil {
    val colors = listOf(R.color.color_f4cce3, R.color.color_d6ccf4, R.color.color_bacef0, R.color.color_abddee, R.color.color_cbeea8, R.color.color_baf1e6, R.color.color_fae5a6, R.color.color_f0b5b2, R.color.color_acefba, R.color.color_bad4ee, R.color.color_ebefae, R.color.color_f2c2b4)
